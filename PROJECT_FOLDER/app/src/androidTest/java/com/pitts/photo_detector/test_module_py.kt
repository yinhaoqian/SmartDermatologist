...
class test_module_py {
    ...
    private val resizeDimension = Pair(64, 72)
...
/*        initClassificationMapping.invoke(appContext)*/
    ...
    fun demoAppTest() {
        val fileNames: Array<String> = arrayOf(
            "TEST_PICTURES/TEST/_DOG.jpg",
            "TEST_PICTURES/TEST/_LIZARD.jpg"
        )
        fileNames.forEach {
            ...
            val result = IMAGENET_CLASSES[score]
            Log.d("Q_TESTPY", "$it -> $result")
        }
    }
